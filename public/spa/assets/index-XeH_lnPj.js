...
import { a as l } from './index-CVZJoh5n.js';
import { r as p } from '../vendor/vendor-emotion-DdM-9MtU.js';
import { ao as d, bn as g, br as u } from './index-C8UyLGsD.js';
import { P } from './PageEditor-D9j2_4il.js';
import { p as j } from './selectors-Ce7e05Iz.js';
import { u as e } from './store-B8XKtjEP.js';
import { T as f } from './PageTitle-L-Sg_uQP.js';
import { g as x } from './identifier-DNYzSWMy.js';
...
import './selectors-BOPtTw1G.js';
const h = p.memo(({ pageId: t }) => {
    const r = e((i) => i.updatePageOptimistically),
      m = e(j.getDocumentById(t)),
      a = m?.title,
      s = m?.metadata?.emoji,
      n = p.useCallback(
        (i) => {
    ...
    return o.jsx(P, { emoji: s, pageId: t, title: a, onEmojiChange: c, onTitleChange: n }, t);
  }),
  b = p.memo(() => {
    const t = u(e),
      r = d(),
    ...
    return (
      t('selectedPageId', m),
      l(() => {
        e.setState({ selectedPageId: void 0 });
      }),
      o.jsxs(o.Fragment, {
        children: [
          o.jsx(f, {}),
          o.jsx(p.Suspense, {
            fallback: o.jsx(g, { debugId: 'PagesPage' }),
            children: o.jsx(h, { pageId: m }),
          }),
        ],
      })
    );
  });
b.displayName = 'PagesPage';
export { b as default };
