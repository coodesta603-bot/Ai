...
هل ترغب في أن أتناسب مع سير عملك بشكل أفضل؟ انتقل إلى [إعدادات الوكيل]({{url}}) واملأ ملف تعريف الوكيل (يمكنك تعديله في أي وقت).`,
  ...
  O = 'تم حذف المجموعة بنجاح',
  R = 'أنت على وشك حذف هذا الوكيل. بمجرد الحذف، لا يمكن استعادته. يرجى تأكيد الإجراء.',
...
- تساعد شارة MCP المستخدمين على تقييم أمان الخادم وميزاته وتعليمات التثبيت بسرعة. يرجى نسخ الكود التالي إلى ملف \`README.md\` الخاص بك:`,
  ...
  ls = Object.freeze(
    Object.defineProperty(
      { __proto__: null, back: Oi, default: mo, finish: Ri, next: Li, title: Gi },
      Symbol.toStringTag,
      { value: 'Module' },
    ),
  ),
...
💡 نصيحة: كلما كانت وصفك أكثر تحديدًا، تمكنا من تلبية احتياجاتك بشكل أفضل`,
  ...
  Ss = Object.freeze(
    Object.defineProperty(
      { __proto__: null, default: Po, header: Fa, pickAgent: Na, skip: Ea, welcomeMessages: Oa },
      Symbol.toStringTag,
      { value: 'Module' },
    ),
  ),
...
const Ra = { placeholder: 'اختيار الوقت', rangePlaceholder: ['وقت البدء', 'وقت الانتهاء'] },
  l = {
    lang: {
